...
foreach($ok as $coderphp):
    ...
    echo "<div style=';padding:6px;width:300px;height:auto;background:white;'><b><a style='font-size:14px;text-decoration:none;color:rgb(130,130,130)'  href='#' onClick='catchValue(); return false;'>$coderphp->displayname</a></b>
        <hr>
